...
public class PmsProductAttributeController {
    ...
    public Object getList(@PathVariable Long cid,
        ...
        // 根据分类查询属性列表或参数列表
        Map<String,Object> pageInfo = productAttributeService.pageInfo(cid,type,pageNum,pageSize);
    ...
    public Object create(@RequestBody PmsProductAttributeParam productAttributeParam, BindingResult bindingResult) {
        // 添加商品属性信息
        productAttributeService.addPmsProductAttribute(productAttributeParam);
    ...
    public Object update(@PathVariable Long id,@RequestBody PmsProductAttributeParam productAttributeParam,BindingResult bindingResult){
        // 修改商品属性信息
        productAttributeService.updatePmsProductAttribute(id,productAttributeParam);
        return new CommonResult().success(null);
    }
    ...
    public Object delete(@RequestParam("ids") List<Long> ids){
        // 批量删除商品属性
        productAttributeService.removeByIds(ids);
        return new CommonResult().success(null);
    }
    ...
    public Object getAttrInfo(@PathVariable Long productCategoryId){
        // 根据分类查询属性列表或参数列表
        productAttributeService.getAttrInfo(productCategoryId);
        return new CommonResult().success(null);
    }
}
